...
func init() {
	...
	psiFs.BoolVar(&config.IncludeCPU, "include-cpu", false, "Include CPU values eplicitly (by default all are included")
	psiFs.BoolVar(&config.IncludeMemory, "include-memory", false, "Include Memory values eplicitly (by default all are included")
	psiFs.BoolVar(&config.IncludeIO, "include-io", false, "Include IO values eplicitly (by default all are included")
}
